...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'setaria-ui/src/utils/date-util';
  import { hasClass } from 'setaria-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'setaria-ui/src/utils/util';
